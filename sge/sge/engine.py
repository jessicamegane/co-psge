...
def setup(parameters_file_path = None):
    ...
    params['EXPERIMENT_NAME'] += "/" + "start_mut_prob_" + str(params['PROB_MUTATION']) + "/" + "prob_mut_probs_" + str(params['PROB_MUTATION_PROBS']) +"/gauss_" + str(params['GAUSS_SD']) + "/delay_" + str(params['DELAY']) 
